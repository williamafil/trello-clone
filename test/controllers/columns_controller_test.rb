...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post columns_url, params: { column: { kanban_id: @column.kanban_id, name: @column.name, position: @column.position } }
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { kanban_id: @column.kanban_id, name: @column.name, position: @column.position } }
